        ...
        <div class="qna_area">
            <div class="qna_header">
                ...
                <div class="search_area">
                    <select class="selectbox select_area" name="qna_sort" id="qna_sort">
                        <option value="all">전체</option>
                        <option value="one">1:1문의</option>
                        <option value="space">장소문의</option>
                    </select>
                </div>
            </div>
	            		...
	            		<c:when test="${!empty qnaList }">
	            			<c:forEach items="${qnaList}" var="qna">
					            ...
					            <div class="list">
				                    <div class="img_area">
					                    <c:choose>
					                    	<c:when test="${!empty qna.spaceImgNm}">
						                    	<img class="list_img" src="${contextPath}${qna.spaceImgPath}${qna.spaceImgNm}">
					                    	</c:when>
					                    	<c:otherwise>
					                    		<img class="list_img" src="${contextPath}/resources/images/defaultUser.jpg">
					                    	</c:otherwise>
					                    </c:choose>
			                    	</div>

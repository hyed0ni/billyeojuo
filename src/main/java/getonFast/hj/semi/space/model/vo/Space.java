...
public class Space {
	...
	public String getSpacePno() {
		return spacePno;
	}

	public void setSpacePno(String spacePno) {
		this.spacePno = spacePno;
	}
	...
	public char getSpaceReco() {
		return spaceReco;
	}

	public void setSpaceReco(char spaceReco) {
		this.spaceReco = spaceReco;
	}
